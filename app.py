...
# 🔹 CONFIG
# ==========================================
CSV_PATH = os.path.join(os.path.dirname(__file__), "generated_images/generated_image_dataset.csv")
DEMOGRAPHICS_CSV_PATH = os.path.join(os.path.dirname(__file__), "user_demographics.csv")
